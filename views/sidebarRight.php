<div class="sidebar-box rounded-5 p-3 p-md-4 text-danger fw-bold mb-3">
    <div class="d-flex justify-content-center align-items-center">
        <h2 class="p-0 m-0">Ruben Winkler</h2>
    </div>
</div>
...
<div class="sidebar-box rounded-5 ps-3 pt-3 pb-5 text-white text-start mb-3">
    ...
    <nav class="sidebar-nav">
        <ul class="list-disc d-grid gap-3 gap-md-5 gap-lg-3 mb-0">
            <li><a href="/ruben-winkler/js/hello/" class="sidebar-link text-decoration-none">Hallo JavaScript</a>
            </li>
        </ul>
    </nav>
</div>
...
<div class="sidebar-box rounded-5 p-3 p-md-4 text-danger fw-bold mb-3">
    <div class="d-flex justify-content-center align-items-center">
        <h2 class="p-0 m-0">Jannis Seemann</h2>
    </div>
</div>
...
<div class="sidebar-box rounded-5 ps-3 pt-3 pb-5 text-white text-start mb-3">
    ...
    <nav class="sidebar-nav">
        <ul class="list-disc d-grid gap-3 gap-md-5 gap-lg-3 mb-0">
            <li><a href="/jannis-seemann/js/hello/" class="sidebar-link text-decoration-none">Hallo JavaScript</a>
            </li>
        </ul>
    </nav>
</div>
...
<div class="sidebar-box rounded-5 ps-3 pt-3 pb-5 text-white text-start mb-3">
    ...
    <nav class="sidebar-nav">
        <ul class="list-disc d-grid gap-3 gap-md-5 gap-lg-3 mb-0">
            <li><a href="/jannis-seemann/php/hello/" class="sidebar-link text-decoration-none">Hallo PHP</a></li>
        </ul>
    </nav>
</div>